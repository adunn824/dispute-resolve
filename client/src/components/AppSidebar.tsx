import { Home, Plus, Search, Settings, FileText, Users, AlertTriangle, BarChart3, Shield, Cog, BookOpen, Building, ListChecks, CheckCircle, Mail, UserCog, Database } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
