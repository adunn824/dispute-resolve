...
export class ObjectStorageService {
  ...
  async uploadFile(storageKey: string, fileBuffer: Buffer, contentType: string): Promise<void> {
  ...
  async setFileAclPolicy(storageKey: string, aclPolicy: ObjectAclPolicy): Promise<void> {
